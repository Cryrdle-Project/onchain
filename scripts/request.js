...
async function main() {
  ...
  // Consumer contract
  const consumerAddress = "0x8dC81B34Ae850a34A0687B16329f3122BC3C85F9"
  const consumerAbiPath = "build/artifacts/contracts/Cryrdle.sol/Cryrdle.json"
  ...
  const subscriptionId = "407"
  // Gas limit for the Chainlink Functions request
  const requestGas = 5500000

  // Default example
  const source = await fs.readFile("./chainlink_functions/source.js", "utf8")
  const args = ["ETH", "USD"]
...
// Code is from ./tasks/Fu_/buildRequestJSON.js
// in the starter kit.
