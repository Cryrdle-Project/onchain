...
task("functions-simulate", "Simulates an end-to-end fulfillment locally for the Cryrdle contract")
  .addOptionalParam(
    "gaslimit",
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const clientFactory = await ethers.getContractFactory("Cryrdle")
