...
task("functions-sub-remove", "Removes a client contract from an Functions billing subscription")
  ...
  .setAction(async (taskArgs) => {
    if (network.name === "hardhat") {
      throw Error(
        'This command cannot be used on a local hardhat chain.  Please specify a valid network or simulate an Cryrdle request locally with "npx hardhat functions-simulate".'
      )
    }
